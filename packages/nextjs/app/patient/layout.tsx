...
const PatientPage = ({ children }: { children: React.ReactNode }) => {
  return (
          ...
          <ul className="space-y-4 font-medium text-2xl">
            ...
            <li>
              ...
              >
                ...
                <span className="ms-4">Check requests</span>
              </Link>
            </li>
            <li>
              <Link
                href="/patient/doctorsList"
                className="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                ...
                <span className="ms-4">Doctors</span>
              </Link>
            </li>
            <li>
              <Link
